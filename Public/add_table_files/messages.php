...
PMA_messages['strHoverDbFastFilter'] = "在搜索项目后回车即可在服务器上所有的数据库中进行过滤";
PMA_messages['strHoverFastFilter'] = "在搜索项目后回车以过滤在数据库中所有的 %s";
PMA_messages['strTables'] = "表";
PMA_messages['strViews'] = "视图";
PMA_messages['strProcedures'] = "存储过程";
PMA_messages['strEvents'] = "事件";
PMA_messages['strFunctions'] = "函数";
...
PMA_messages['phpErrorsFound'] = "<div class=\"error\">在服务上检测到错误！<div>请查看此窗口的底部。<input id=\"pma_ignore_errors_popup\" type=\"submit\" value=\"忽略\" style=\"float: right; margin: 20px;\"><input id=\"pma_ignore_all_errors_popup\" type=\"submit\" value=\"忽略全部\" style=\"float: right; margin: 20px;\"></div></div>";
PMA_messages['phpErrorsBeingSubmitted'] = "<div class=\"error\">在服务上检测到错误！<br/>As per your settings, they are being submitted currently, please be patient.<br/><img src=\"./themes/pmahomme/img/ajax_clock_small.gif\" width=\"16\" height=\"16\" alt=\"ajax clock\"/></div>";
