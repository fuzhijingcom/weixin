...
<html lang="zh-cn" data-lang="zh-cn" data-template="simple" class="lang-zh-cn"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta name="keywords" content="新浪,云计算,SAE,SEC,SCS,公有云平台,弹性云,应用引擎,分布式,负载均衡,web服务器">        <meta name="description" content="">    <title>用户注册&nbsp;-&nbsp;新浪云</title>
...
$SC['cookie_domain'] = '.sinacloud.com';
    ...
    <script type="text/javascript" src="/Public/register_files/common.js"></script><style type="text/css"></style> 
    <script type="text/javascript" src="/Public/register_files/common.part2.js"></script>
    <script type="text/javascript" src="/Public/register_files/sinacloud_sso.js"></script>
...
<script type="text/javascript" src="/Public/register_files/register.js"></script>
...
<body class="">
    ...
    <div class="head">
        <div class="head-logo"><a class="logo" href="https://www.sinacloud.com/"><img src="/Public/register_files/sinacloud_logo.png"></a></div>
        <div class="navbar">
            <ul class="nav navbar-nav">
                <li class="active"><a href="https://www.sinacloud.com/">首页</a></li>
                <li class="nav-dropdown ">
                    <a href="javascript:void(0);">产品</a>
                    <ul class="nav-dropdown-list">
                        <li><a target="_blank" href="https://www.sinacloud.com/sae.html">云应用 SAE</a></li><li><a target="_blank" href="https://www.sinacloud.com/sch.html">云虚拟主机</a></li><li><a target="_blank" href="https://sae.sina.com.cn/?m=appmarket&a=index">云市场 SAM</a></li><li><a target="_blank" href="https://www.sinacloud.com/scs.html">云存储 SCS</a></li><li><a target="_blank" href="https://www.sinacloud.com/live.html">云直播 SLS</a></li><li><a target="_blank" href="http://yunshangdian.com/">云商店 SCM</a></li><li><a target="_blank" href="http://mail.sina.net/">云邮箱 SEM</a></li>                    </ul>
                </li>
                ...
                <li class=""><a href="https://www.sinacloud.com/index/faq/sort_id/1.html">常见问题</a></li>
            </ul>
        </div>
        ...
        <div class="account-dropbox">
            <div class="db veral-top">
                <a class="db-nav" href="javascript:void(0);">控制台&nbsp;<i class="c-arrow"></i></a>
                <ul class="db-dropdown-list">
                    <li><a href="https://sae.sina.com.cn/">云应用 SAE</a></li><li><a href="https://sch.sinacloud.com/">云虚拟主机</a></li><li><a href="https://sae.sina.com.cn/?m=appmarket&a=index">云市场 SAM</a></li><li><a href="https://open.sinastorage.com/?c=console">云存储 SCS</a></li><li><a href="https://live.sinacloud.com/">云直播 SLS</a></li><li><a href="https://sem.sinacloud.com/">云邮箱 SEM</a></li>                </ul>
            </div>
            <span class="divider veral-top">|</span>
            <div class="account">
                <a class="user" href="https://www.sinacloud.com/ucenter.html">
                                        <i class="level level1"></i>                    <span class="username veral-top">用户2392458015</span>
                    <i class="c-arrow"></i>
                </a>
                <ul class="account-dropdown-list">
                    <li><a href="https://www.sinacloud.com/ucenter.html">用户中心</a></li>
                    <li><a href="https://www.sinacloud.com/ucenter/recharge.html">充值</a></li>
                    <li>
                        <a href="https://www.sinacloud.com/ucenter/account.html">普通型                            <img class="level-up" src="/Public/register_files/level_up_arrow.png" alt="提升">
                        </a>    
                    </li>
                    <li><a href="javascript:scsso.logout(encodeURIComponent('https://www.sinacloud.com/public/logout.html?referer='+encodeURIComponent(window.location.href)));">退出</a></li>
                </ul>
            </div>
                    </div>
    </div>
...
<div id="page-contact-btn">
    <a id="delete-contact" href="javascript:void(0);"><img src="/Public/register_files/close_contact.png"></a>
    <ul class="contact-ul">
            ...
            <a class="contact-item ent-item" href="javascript:void(0);"></a>
                ...
                <p class="consult-level">升级<a target="_blank" href="https://www.sinacloud.com/index/ent.html?from=float">企业版</a>，获得专属客户经理支持&nbsp;&nbsp;<a target="_blank" href="https://www.sinacloud.com/public/intention.html?from=float">免费咨询</a>
                </p><div class="divider"></div>
                <p class="consult-way"><a target="_blank" href="http://saebbs.com/forum.php">社区</a>&nbsp;&nbsp;<a target="_blank" href="https://www.sinacloud.com/ucenter/workorderadd.html?from=sidebar">工单</a>&nbsp;<a target="_blank" href="http://weibo.com/saet">微博</a>商务咨询：010-62676626</p>        </div></li>
        <li class="contact-li qrcode">
            <a class="contact-item qrcode-item" href="javascript:void(0);"></a>
            <div class="qrcode-box">
                <img src="/Public/register_files/weixin.png" alt="SinaAppEngine">
                <p>新浪云微信公众号</p>
            </div>
        </li>
...
<!--/广告组件-->
                ...
                <div class="step-detail">
                    <ul class="steps">
                        <li class="step step-success">
                            <a href="https://www.sinacloud.com/sso/register.html#">1、微博授权</a>
                        </li>
                        <li class="step step-primary">
                            <a href="https://www.sinacloud.com/sso/register.html#">2、补充信息</a>
                        </li>
                        <li class="step">
                            <a href="https://www.sinacloud.com/sso/register.html#">3、注册完成</a>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="row">
                <div id="cfm-identity" class="col-md-8 reg_info reg_content">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-md-offset-3">
                            <div class="register-type register-cur" id="register-personal"><a href="https://www.sinacloud.com/sso/register.html#CMD:REGISTER-PERSONAL">个人注册</a></div>
                            <span class="register-vline">|</span>
                            <div class="register-type" id="register-official"><a href="https://www.sinacloud.com/sso/register.html#CMD:REGISTER-OFFICIAL">官方注册</a></div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="alert alert-info" role="alert" id="register-notice">注册后账号用于个人，如果用于非个人业务，建议您使用官方注册通道。</div>
                    </div>
                    <!--结束注册的分类-->
                    <div class="row">
                        <form class="form-horizontal" valid="true">
                                                      
                           
                           
                            <div class="form-group">
                                <label class="col-md-3 control-label">手机验证码<span style="color:red">&nbsp;*</span></label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" id="sms-vcode" checktype="null" nullmsg="请填写必填项">
                                                                    </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 control-label">安全邮箱<span style="color:red">&nbsp;*</span></label>
                                <div class="col-md-8">
                                    <input type="email" class="form-control" id="email" placeholder="很重要！部署代码及管理应用等重要操作时使用的邮箱" checktype="mail" errmsg="邮箱格式不正确">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label">如何了解到盗版新浪云<span style="color:red">&nbsp;*</span></label>
                                <div class="col-md-8">
                                      <label class="checkbox-inline fr">
                                        <input type="checkbox" name="reg-source" class="searchStatus reg-source" value="fr" checktype="null" errmsg="请问您是如何了解到新浪云的？"> 他人推荐                                    </label><label class="checkbox-inline wb">
                                        <input type="checkbox" name="reg-source" class="searchStatus reg-source" value="wb" checktype="null" errmsg="请问您是如何了解到新浪云的？"> 微博微信                                    </label><label class="checkbox-inline me">
                                        <input type="checkbox" name="reg-source" class="searchStatus reg-source" value="me" checktype="null" errmsg="请问您是如何了解到新浪云的？"> 媒体书籍                                    </label><label class="checkbox-inline tc">
                                        <input type="checkbox" name="reg-source" class="searchStatus reg-source" value="tc" checktype="null" errmsg="请问您是如何了解到新浪云的？"> 技术社区                                    </label><label class="checkbox-inline ap">
                                        <input type="checkbox" name="reg-source" class="searchStatus reg-source" value="ap" checktype="null" errmsg="请问您是如何了解到新浪云的？"> 推广活动                                    </label><label class="checkbox-inline ad">
                                        <input type="checkbox" name="reg-source" class="searchStatus reg-source" value="ad" checktype="null" errmsg="请问您是如何了解到新浪云的？"> 广告                                    </label><label class="checkbox-inline se">
                                        <input type="checkbox" name="reg-source" class="searchStatus reg-source" value="se" checktype="null" errmsg="请问您是如何了解到新浪云的？"> 搜索引擎                                    </label><label class="checkbox-inline un">
                                        <input type="checkbox" name="reg-source" class="searchStatus reg-source" value="un" checktype="null" errmsg="请问您是如何了解到新浪云的？"> 以上选项未包含                                    </label>                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-offset-3 col-md-8">
                                    <div class="checkbox">
                                        ...
                                        注册成功后奖励云豆 <b>200亿</b> 颗
                                        <button class="btn btn-base" type="sunmit">注册</button>
                                    </div>
                                </div>
                            </div>
                        </form>
                ...
                <div class="col-md-4 reg_content">
                    <div class="help">
                        <h4>注册常见问题</h4>
                        <ul>
                            <li><a href="https://www.sinacloud.com/home/index/faq_detail/doc_id/184.html" target="_blank">手机号被占用？</a></li>
                            <li><a href="https://www.sinacloud.com/home/index/faq_detail/doc_id/184.html" target="_blank">邮箱被占用？</a></li>
                            <li><a href="https://www.sinacloud.com/home/index/faq_detail/doc_id/183.html" target="_blank">收不到短信验证码？</a></li>
                            <li><a href="https://www.sinacloud.com/home/index/faq_detail/doc_id/182.html" target="_blank">如何确定我是被人邀请的？</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript" src="/Public/register_files/valid.js"></script>
    ...
    <div class="footer">
        ...
        <div class="footer-item">
            ...
            <ul class="footer-link">
                <!--<li class="fs12">商务咨询：400-823-1517</li>-->
        ...
        <div class="footer-item follow-item">
            ...
            <div class="app-download">
                <a href="https://www.sinacloud.com/sae/index/mobile.html"><img src="/Public/register_files/sae_app_download.png"></a>
            </div>
        ...
        <div class="footer-item">
            ...
            <div class="true-cloud">
                <a href="http://www.dca.org.cn/" target="_blank"><img src="/Public/register_files/kexinyun.png"></a>
                <ul>
    ...
    <div class="copyright">Copyright © 1996-2017 SINA Corporation All Rights Reserved. <a href="http://www.miibeian.gov.cn/" target="_blank">京ICP证000007-104</a></div>
    <div style="display:none;">
<script type="text/javascript">
    var cnzz_protocol = (("https:" == document.location.protocol) ? " https://" : " http://");
    document.write(unescape("%3Cspan id='cnzz_stat_icon_1255888816'%3E%3C/span%3E%3Cscript src='" + cnzz_protocol + "s4.cnzz.com/z_stat.php%3Fid%3D1255888816' type='text/javascript'%3E%3C/script%3E"));</script><span id="cnzz_stat_icon_1255888816"><a href="http://www.cnzz.com/stat/website.php?web_id=1255888816" target="_blank" title="站长统计">站长统计</a></span><script src="/Public/register_files/z_stat.php" type="text/javascript"></script><script src="/Public/register_files/core.php" charset="utf-8" type="text/javascript"></script>
</div>
...
<iframe src="/Public/register_files/saved_resource.html" scrolling="no" width="0" height="0" style="display: none;"></iframe></body></html>